        ...
        {days.length === 0 ? (
          ...
          <div className="space-y-8">
            {days.map((day, index) => {
              ...
              return (
                <div key={day.dateKey} className="relative pl-8 md:pl-10 mb-2">
                  {/* Timeline line */}
                  <div className={cn(
                  ...
                  <div className={cn(
                    "rounded-3xl transition-colors border-2 p-2 sm:p-4 -mx-2 sm:-mx-4",
                    isToday ? "bg-emerald-50/60 dark:bg-emerald-900/20 border-emerald-500/30 shadow-sm" : "border-transparent"
                  )}>
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 rounded-3xl">
      ...
      <AnimatePresence>
        {isAddDayModalOpen && (
          <div className="fixed inset-0 z-[120] flex items-center justify-center p-4">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="relative bg-white dark:bg-gray-900 text-gray-900 dark:text-white w-full max-w-md rounded-3xl shadow-2xl p-4 sm:p-6 md:p-8 max-h-[90vh] overflow-y-auto">
